...
protcseg:
  ...
  call bootmain			#调用main.c中的bootmain，加载内核镜像
...
outb(int port, uint8_t data)
{
    ...
    7c9f:	ee                   	out    %al,(%dx)
    7ca0:	0f b6 c1             	movzbl %cl,%eax
    7ca3:	b2 f3                	mov    $0xf3,%dl
    7ca5:	ee                   	out    %al,(%dx)
    7ca6:	0f b6 c5             	movzbl %ch,%eax
    7ca9:	b2 f4                	mov    $0xf4,%dl
    7cab:	ee                   	out    %al,(%dx)
    7cac:	c1 e9 10             	shr    $0x10,%ecx
    7caf:	b2 f5                	mov    $0xf5,%dl
    7cb1:	0f b6 c1             	movzbl %cl,%eax
    7cb4:	ee                   	out    %al,(%dx)
    7cb5:	c1 e9 08             	shr    $0x8,%ecx
    7cb8:	b2 f6                	mov    $0xf6,%dl
    7cba:	80 c9 e0             	or     $0xe0,%cl
    7cbd:	88 c8                	mov    %cl,%al
    7cbf:	ee                   	out    %al,(%dx)
...
00007ce2 <readseg>:
    ...
    7d1d:	8d 65 f4             	lea    0xfffffff4(%ebp),%esp
    7d20:	5b                   	pop    %ebx
    7d21:	5e                   	pop    %esi
    7d22:	5f                   	pop    %edi
    7d23:	5d                   	pop    %ebp
